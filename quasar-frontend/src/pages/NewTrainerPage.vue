      ...
      <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
        ...
        <div class="row items-center">
          <q-input
            ...
            class="col q-mr-md"
            :rules="[(val) => !!val || 'Enter trainer\'s specialization']"
          />
          <q-select
            ...
            class="col"
            :rules="[(val) => !!val || 'Enter trainer\'s certifications']"
          />
        </div>
        ...
        <div class="row items-center">
          <q-input
            ...
            class="col q-mr-md"
            :rules="[(val) => !!val || 'Enter years of experience']"
            type="number"
            min="1"
          />
        ...
        <div class="row items-center">
          ...
          <q-select
            ...
            new-value-mode="add-unique"
            class="col"
            :rules="[(val) => !!val || 'Enter availability schedule']"
          />
        </div>
