    ...
    <div class="column q-gutter-y-md">
      <div class="row items-center">
        <div class="col-12 col-md-4">
          <q-btn :to="{ name: 'staff' }" flat icon="mdi-arrow-left" label="Back" textColor="secondary" />
        </div>
        <div class="col-12 col-md-8">
          <h1 class="text-h6">New Staff</h1>
        </div>
      </div>
      <q-form
        @submit="onSubmit"
      ...
      >
        ...
        <span class="text-h6">Start and End date</span>

        <div class="row items-center">
          <q-input filled v-model="text" label="Start Date" class="col q-mr-md" type="date" />
          <q-input filled v-model="text" label="End Date" class="col" type="date" />
        </div>
