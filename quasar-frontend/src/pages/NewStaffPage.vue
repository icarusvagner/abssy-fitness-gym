  ...
  <q-page padding>
    ...
    <div class="column q-gutter-y-md">
      ...
      >
        ...
        <div class="row items-center">
          <q-input filled v-model="form.first_name" label="First Name" class="col q-mr-md" :rules="[ val => !!val || 'Enter staff first name' ]" />
          <q-input filled v-model="form.middle_name" label="Middle Name" class="col q-mr-md" :rules="[ val => !!val || 'Enter staff middle name' ]" />
          <q-input filled v-model="form.last_name" label="Last Name" class="col" :rules="[ val => !!val || 'Enter staff last name' ]" />
        </div>
        ...
        <div class="row items-center">
          <q-input filled v-model="form.relationship" label="Relationship" class="col q-mr-md" :rules="[ val => !!val || 'Enter relationship' ]" />
        ...
        <div class="row items-center">
          <q-input filled v-model="form.username" suffix=".staff" label="Username" class="col q-mr-md text-right" :rules="[ val => !!val || 'Enter username' ]" />
          <q-input filled v-model="form.password" label="Password" class="col" type="password" :rules="[ val => !!val || 'Enter password' ]" />
        </div>
        ...
        <div class="row items-center">
          <q-select label="Shift Schedule" filled v-model="scheds" use-input use-chips multiple hide-dropdown-icon input-debounce="0" new-value-mode="add-unique" class="col q-mr-md" :rules="[ val => !!val || 'Enter shift schedule' ]" />
          <q-select filled v-model="form.role" :options="staff_rol" label="Select position" class="col" :rules="[ val => !!val || 'Select position' ]" />
        </div>
        <q-toggle v-model="accept" label="I accept the license and terms" class="col q-mr-md" />

        <div>
          <q-btn label="Submit" type="submit" color="secondary" :disabled="isSubmit" />
...
<script setup lang="ts">
  ...
  const staff_rol = ref(['receptionis','cleaner','encoder','maintenance','attendant','officer','childcare','dietitian','consultant','instructor','manager'])
