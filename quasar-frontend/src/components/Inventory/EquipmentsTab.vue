      ...
      >
        ...
        <q-card-section>
          <div class="column q-gutter-y-sm">
            <q-input outlined color="secondary" v-model="equipmentForm.brand_name" label="Brand name" :rules="[ val => !!val || 'Enter equipment brand name']" />
            <q-input outlined color="secondary" v-model="equipmentForm.classification" label="Classification" :rules="[ val => !!val || 'Enter equipment classification']" />
